...
graph TD
    ...
    NSTEMI["NSTEMI"]
    UA["Unstable angina"]
    StableAngina["Stable angina with suspected CAD +/- dyspnoea"]
    Stabilised["Stabilised symptom(s) after ACS or revascularisation"]
    Asymptomatic["Asymptomatic CAD*"]
    NewOnsetHF["New-onset HF with suspected CAD"]
    Vasospastic["Vasospastic angina"]
    Microvascular["Micro-vascular angina"]
