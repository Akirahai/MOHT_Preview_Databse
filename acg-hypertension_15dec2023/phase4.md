...
```mermaid
graph TD
    Start{BP Reduction} -->|5 mmHg SBP| Outcome1["Major Cardiovascular Events: ~10%\n(Irrespective of CVD history or baseline BP)"]
    Start -->|10 mmHg SBP or 5 mmHg DBP| Outcome2["Heart Disease: ~40%"]
    Start -->|10 mmHg SBP or 5 mmHg DBP| Outcome3["Stroke: ~35%"]
    Start -->|10 mmHg SBP or 5 mmHg DBP| Outcome4["Coronary Heart Disease: ~15%"]
    Start -->|10 mmHg SBP or 5 mmHg DBP| Outcome5["Cardiovascular Mortality: ~20%"]
    Start -->|10 mmHg SBP or 5 mmHg DBP| Outcome6["All-Cause Mortality: ~10%"]
```
...
```mermaid
graph TD
    Grade2["Grade 2 hypertension and above\n≥ 160/100 mmHg"]
    Grade1["Grade 1 hypertension\n140–159/90–99 mmHg"]
    HighNormal["High-normal BP\n130–139/85–89 mmHg"]
    Lifestyle["Adopt lifestyle interventions"]
    
    RiskAny["Any cardiovascular risk"]
    RiskHigh["High to very high cardiovascular risk\n(because of presence of relevant conditions or risk score >20% (SG-FRS-2023))"]
    RiskLow["Low to intermediate cardiovascular risk\nrisk score ≤20% (SG-FRS-2023)"]
    
    ActionStart["Start or intensify pharmacotherapy\nLower severely elevated BP with pharmacotherapy, regardless of cardiovascular risk and presence of other risk factors."]
    ActionConsider1["Consider pharmacotherapy, especially if SG-FRS-2023 is between 10–20%, or if BP not controlled after 3 to 6 months"]
    ActionConsider2["Consider pharmacotherapy, especially if not controlled after 3 to 6 months"]
    ActionNo["No pharmacotherapy required\nThere is limited evidence on the benefits of starting pharmacotherapy; consider pharmacotherapy if the patient's BP remains close to 140/90 mmHg after a period of lifestyle intervention."]
    Note1["The decision to start pharmacotherapy depends on the degree of cardiovascular risk and likelihood of achieving BP control with lifestyle intervention alone. If not started together with lifestyle intervention, consider pharmacotherapy if the patient does not reach target BP after 3 to 6 months of lifestyle intervention."]

    Grade2 --> RiskAny
    RiskAny --> ActionStart
    Grade1 --> RiskHigh
    RiskHigh --> ActionStart
    Grade1 --> RiskLow
    RiskLow --> ActionConsider1
    ActionConsider1 --> Note1
    HighNormal --> RiskHigh
    RiskHigh --> ActionConsider2
    HighNormal --> RiskLow
    RiskLow --> ActionNo
    
    Lifestyle --> ActionStart
    Lifestyle --> ActionConsider1
    Lifestyle --> ActionConsider2
    Lifestyle --> ActionNo
```
