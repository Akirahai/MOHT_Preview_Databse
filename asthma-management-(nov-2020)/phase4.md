...
```mermaid
graph TD
    Diagnosis["Diagnosis"] --> Assessment["Assessment (see Recommendations 1 to 3)"]
    Assessment --> Management["Management (see Recommendations 4 to 9)"]
    Management --> Assessment
    Management --> AcuteExacerbations["Management of acute exacerbations"]
    
    Influencing["Influencing factors (see Recommendation 3)"] --> Symptoms["Symptoms (see Recommendation 2)"]
    Influencing --> Risk["Risk of poor outcomes (see Recommendation 1)"]
```
