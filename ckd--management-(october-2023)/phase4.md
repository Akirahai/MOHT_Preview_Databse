...
```mermaid
graph TD
    OverallApproach["Overall approach to management of early-stage CKD\nManagement varies by underlying cause"] --> CKDStaging["CKD staging includes:\ni. GFR\nii. UACR\niii. Cause(s)"]
    OverallApproach --> PersonalisePlan["Personalise CKD management plan based on CKD stage\nAim: Delaying CKD progression, Reducing CV complications"]
    PersonalisePlan <--> SharedCare["Shared or multi-disciplinary care\nConsider depending on CKD progression and other clinical needs"]
    PersonalisePlan --> Pharm["Pharmacological treatment\n- Optimise BP and albuminuria\n- ACEi/ARB titrated to max tolerated dose\n- Add SGLT2i if albuminuria persists\n- Treat comorbidities: HTN, Dyslipidaemia, T2DM"]
    PersonalisePlan --> Lifestyle["Lifestyle intervention\n- Healthy diet\n- Physical activity\n- Smoking cessation"]
    PersonalisePlan --> Followup["Follow-up and monitoring\n- Regular follow-up\n- More frequent reviews for high risk\n- Review and adjust plan"]
```
